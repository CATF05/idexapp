...
class RapportPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        children: [
          ExampleSidebarX(controller: _controller, home: AccountantScreen(),),
          const Expanded(
            child: RapportPageHome(),
          ),
        ],
      ),
    );
...
class RapportPageHome extends StatefulWidget {
  const RapportPageHome({super.key});

  @override
  State<StatefulWidget> createState() => _RapportPageHomeState();
}

class _RapportPageHomeState extends State<RapportPageHome> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Rapports Financiers", style: TextStyle(color: Colors.white)),
