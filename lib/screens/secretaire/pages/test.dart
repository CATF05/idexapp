...
// import 'package:frontend/screens/secretaire/sauvegarde_pdf.dart';
...
//         //   tabs: [Tab(text: document.name)],
//         //   isScrollable: true,
//         // ),
//       ),
//       body: PdfPreview(
//         maxPageWidth: 700,
//         build: (format) => document.builder(format, _data),
//         actions: actions,
...
//   //   ul.launchUrl(
//   //     Uri.parse(
//   //       'https://github.com/DavBfr/dart_pdf/blob/master/demo/lib/examples/${document.file}',
//   //     ),
//   //   );
//   // }
...
// const document = Example('DOCUMENT', 'document.dart', generateDocument);
