...
class EmployeView extends StatelessWidget {
  ...
  EmployeView({super.key, required this.employeModel, required this.home});
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          ...
          Expanded(
            child: EmployeViewHome(employeModel: employeModel),
          ),
        ],
      ),
    );
...
class EmployeViewHome extends ConsumerStatefulWidget {
  final EmployeModel employeModel;
  const EmployeViewHome({super.key, required this.employeModel});

  @override
  ConsumerState<EmployeViewHome> createState() => _EmployeViewHomeState();
}

class _EmployeViewHomeState extends ConsumerState<EmployeViewHome>
  ...
  //       .where('employeAbscent', isEqualTo: true).get();
                    ...
                    Row(
                      children: [
                        EtudiantProfilWidget(
                          fullName: widget.employeModel.nom,
                          urlPhoto: "",
                        ),
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              widget.employeModel.nom,
                              style: const TextStyle(fontWeight: FontWeight.bold),),
                            Text(widget.employeModel.role),
                          ],
                        ),
                      ],
                    ),
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Expanded(
                                flex: 2,
                                child: Text(
                                  widget.employeModel.telephone.toString(),
                                ),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Expanded(
                                flex: 2,
                                child: Text(
                                  formatCurrency(widget.employeModel.salaire),
                                ),
                              ),
                            ],
                          ),
  ...
  //         await FirebaseFirestore.instance.collection('cours').where("id", whereIn: widget.employeModel.cours).get();
  ...
  //               employeAbscent: p.employeAbscent,
  //             ),
  //           );
  //         }
