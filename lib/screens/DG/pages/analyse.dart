...
class AnalysePageScreen extends StatelessWidget {
  AnalysePageScreen({super.key});
...
class AnalysePageHome extends StatefulWidget {
  const AnalysePageHome({super.key});

  @override
  State<AnalysePageHome> createState() => _AnalysePageHomeState();
}

class _AnalysePageHomeState extends State<AnalysePageHome> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Analyse de Performance", style: TextStyle(color: Colors.white)),
