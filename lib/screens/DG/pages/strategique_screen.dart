...
class StrategicPlanningScreen extends StatelessWidget {
  StrategicPlanningScreen({super.key});
...
class StrategicPlanningHome extends StatefulWidget {
  const StrategicPlanningHome({super.key});

  @override
  State<StrategicPlanningHome> createState() => _StrategicPlanningHomeState();
}

class _StrategicPlanningHomeState extends State<StrategicPlanningHome> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Planification Stratégique', style: TextStyle(color: Colors.white)),
